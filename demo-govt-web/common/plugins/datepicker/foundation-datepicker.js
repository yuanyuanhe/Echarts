...
! function($) {
    ...
    var Datepicker = function(element, options) {
        ...
        if (this.isRTL) {
            ...
            this.picker.find('.prev i, .next i')
                .toggleClass('glyphicon-menu-left glyphicon glyphicon-menu-right');
        }
    ...
    var DPGlobal = {
        ...
        headTemplate: '<thead>' +
            '<tr>' +
            '<th class="prev"><i class="glyphicon glyphicon-menu-left"/></th>' +
            '<th colspan="5" class="date-switch"></th>' +
            '<th class="next"><i class="glyphicon glyphicon-menu-right"/></th>' +
            '</tr>' +
            '</thead>',
